<template>
  <div>
              ...
              <div class="user_list">
                ...
                <el-table
                    ...
                    <template slot-scope="scope">
                      <el-button type="text" size="small" @click="safety2(scope)">编辑</el-button>
      ...
      <div v-show="mtk2" class="mtk">
      <div class="mtk_center">
      <div class="mtk_top">
        <ul>
          <li>添加用户</li>
          <li class="close"  @click="close2">×</li>
        </ul>
      </div>
      <div class="mtk_bottom">
        <div class="mtk_bottom_center">
          <div class="oldpw">
          <label for="userName" >*用户名：</label>
          <input id="userName" disabled type="text" ref="userName" v-model="userName">
        </div>
        <div class="newpw">
          <label for="trueName">　*姓名：</label>
          <input id="trueName" type="text" ref="trueName">
        ...
        <div class="mtk_btn">
          <div class="mtk_yes" @click="updatepass2">确定</div>
          <div class="mtk_no" @click="cancel2">取消</div>
        </div>
        </div>
      </div>
      </div>
