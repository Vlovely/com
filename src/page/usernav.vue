  ...
  <div>
    ...
    <div class="nav_box">
      ...
      <div class="nav_second">
        <div class="nav_t">
        <ul>
          <li><router-link to="/user" style="color:white"><span><img src="../../static/img/n1.png"></span>用户管理</router-link></li>
          <li><router-link to="/student" style="color:white"><span><img src="../../static/img/n2.png"></span>课程管理</router-link></li>
